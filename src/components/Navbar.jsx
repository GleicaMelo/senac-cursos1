    ...
    <nav className="bg-gradient-to-t from-blue-100 to-orange-100 py-5 px-10 text-blue-600 flex items-center justify-between shadow-sm">
      ...
      <Link to="/">
        <img
          ...
          alt="Senac"
          className="h-16 hover:opacity-80 transition duration-200"
        />
      </Link>

      {/* Botão de Login */}
      <Link to="/login">
        <button className="relative flex items-center px-6 py-2 rounded-full bg-white text-blue-300 hover:text-white font-semibold shadow-md hover:bg-blue-300 transition-all duration-300 border-4 border-blue-300 hover:border-white">
          {/* Círculo com ícone */}
