    ...
    <>
      <div className="h-full bg-gradient-to-br from-blue-200 via-orange-200 to-blue-200 p-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-orange-200 rounded-full blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-orange-200 rounded-full blur-xl opacity-20 animate-pulse"></div>
        </div>

        <main className="flex-grow p-6 md:p-10 relative z-10">
          {/* CABEÇALHO */}
          <header className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-blue-700">Cursos</h1>
          ...
          {/* 🔎 BUSCA + FILTRO */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10 relative">
            {/* INPUT COM DROPDOWN */}
            <div className="relative w-full md:w-1/2">
              <input
                ...
                className="bg-white border border-gray-300 p-3 rounded-xl w-full shadow-sm focus:ring-2 focus:ring-blue-500 outline-none transition"
              />

              {/* DROPDOWN */}
              {mostrarLista && busca && (
                <div className="absolute z-30 w-full bg-white border border-gray-200 rounded-xl shadow-lg mt-2 max-h-64 overflow-auto">
                  {filtrados.length > 0 ? (
                    filtrados.map((curso) => (
                      <button
                        key={curso.id}
      ...
      <footer className="bg-white w-full py-10 px-4 text-center shadow-inner border-t border-blue-400">
        <div className="flex flex-col items-center mb-8">
          <h3 className="text-4xl font-bold text-blue-700 mb-4">Senac</h3>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-4">
          {/* Facebook */}
          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-500 transition">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/cursossenacacailandia" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-pink-500 transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
          ...
          {/* WhatsApp */}
          <a href="https://wa.me/559992120154" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-green-600 transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
